...
class StartEntriesView(View):
    ...
    async def get(self) -> Response:
        ...
        if "startlistId" in self.request.rel_url.query:
            ...
            start_entries = await StartEntriesService.get_start_entries_by_bib(db, bib)
        else:
    ...
    async def post(self) -> Response:  # noqa: C901
        ...
        try:
            await UsersAdapter.authorize(token, roles=["admin", "event-admin", "race-result", "race-office"])
