...
async def test_generate_raceplan_for_individual_sprint_event_J10(  # noqa: N802
    http_service: Any,
    token: MockFixture,
    ...
    async with ClientSession() as session:
        ...
        async with session.get(url) as response:
            ...
            with open(
                "tests/files/expected_raceplan_individual_sprint_J10.json"
            ) as file:
...
@pytest.mark.contract
async def test_generate_raceplan_for_individual_sprint_event_J11(  # noqa: N802
    http_service: Any,
    token: MockFixture,
    clear_db: AsyncGenerator,
) -> None:
    ...
    async with ClientSession() as session:
        ...
        async with session.get(url) as response:
            ...
            with open(
                "tests/files/expected_raceplan_individual_sprint_J11.json"
            ) as file:
                expected_raceplan = json.load(file)
...
@pytest.mark.contract
async def test_generate_raceplan_for_individual_sprint_event_G11_10(  # noqa: N802
    http_service: Any,
    token: MockFixture,
    clear_db: AsyncGenerator,
) -> None:
    ...
    async with ClientSession() as session:
        ...
        async with session.get(url) as response:
            ...
            with open(
                "tests/files/expected_raceplan_individual_sprint_G11_10.json"
            ) as file:
                expected_raceplan = json.load(file)
...
async def test_generate_raceplan_for_individual_sprint_event_all(
    ...
    async with ClientSession() as session:
        ...
        async with session.get(url) as response:
            ...
            with open("tests/files/expected_raceplan_individual_sprint.json") as file:
                expected_raceplan = json.load(file)
...
@pytest.mark.contract
async def test_generate_raceplan_for_individual_sprint_event_G11_7(  # noqa: N802
    http_service: Any,
    token: MockFixture,
    clear_db: AsyncGenerator,
) -> None:
    ...
    async with ClientSession() as session:
        ...
        async with session.get(url) as response:
            ...
            with open(
                "tests/files/expected_raceplan_individual_sprint_G11_7.json"
            ) as file:
                expected_raceplan = json.load(file)
